...
static const Entry s_cryptoAppleNative[] =
{
    ...
    DllImportEntry(AppleCryptoNative_Sha3DigestFree)
    DllImportEntry(AppleCryptoNative_Sha3DigestOneShot)
    DllImportEntry(AppleCryptoNative_Sha3DigestUpdate)
    DllImportEntry(AppleCryptoNative_Sha3DigestReset)
