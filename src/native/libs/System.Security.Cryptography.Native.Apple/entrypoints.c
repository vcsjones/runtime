...
static const Entry s_cryptoAppleNative[] =
{
    ...
    DllImportEntry(AppleCryptoNative_Ed25519Generate)
    DllImportEntry(AppleCryptoNative_Ed25519Sign)
    DllImportEntry(AppleCryptoNative_Ed25519ValidPrivateKey)
    DllImportEntry(AppleCryptoNative_Ed25519ValidPublicKey)
    DllImportEntry(AppleCryptoNative_Ed25519Verify)
