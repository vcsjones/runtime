...
#pragma warning restore SYSLIB0039
        ...
        private static bool GetSupportsSha3()
        {
            ...
            if (OperatingSystem.IsMacOSVersionAtLeast(26) || OperatingSystem.IsIOSVersionAtLeast(26) || OperatingSystem.IsMacCatalystVersionAtLeast(26) || OperatingSystem.IsTvOSVersionAtLeast(26))
            {
                return true;
            }
